...
static aml_ptr_t connect_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t field_list() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_bank_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_bitfield() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_bytefield() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_dword_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_qword_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_create_word_field() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_data_region() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_external() { return AML_PREFIX_ERROR; }
...
static aml_ptr_t def_power_res() { return AML_PREFIX_ERROR; }

static aml_ptr_t def_thermal_zone() { return AML_PREFIX_ERROR; }
...
static aml_ptr_t def_event() { return AML_PREFIX_ERROR; }
  ...
  switch (token)
    {
      case EXT_OP_PREFIX:
        {
          ...
          switch (token)
            {
              case EXT_BANK_FIELD_OP: return def_bank_field();
              case EXT_CREATE_FIELD_OP: return def_create_field();
              case EXT_DATA_REGION_OP: return def_data_region();
              case EXT_DEVICE_OP: return def_device(map_ptr);
              case EXT_EVENT_OP: return def_event();
              case EXT_FIELD_OP: return def_field();
              case EXT_INDEX_FIELD_OP: return def_index_field();
              case EXT_MUTEX_OP: return def_mutex();
              case EXT_OP_REGION_OP: return def_op_region();
              case EXT_POWER_RES_OP: return def_power_res();
              case EXT_THERMAL_ZONE_OP: return def_thermal_zone();
              case 0x83: return def_processor();
              default:
                {
      ...
      case METHOD_OP: return def_method();
      case EXTERNAL_OP: return def_external();
      case CREATE_BITFIELD_OP: return def_create_bitfield();
      case CREATE_BYTEFIELD_OP: return def_create_bytefield();
      case CREATE_DWORDFIELD_OP: return def_create_dword_field();
      case CREATE_QWORDFIELD_OP: return def_create_qword_field();
      case CREATE_WORDFIELD_OP: return def_create_word_field();
      default:
        {
          return AML_PREFIX_ERROR;
        }
